...
+             34 LOAD_CONST               2 ('label')
+             36 LOAD_CONST               7 (4)
+             38 BUILD_MAP                1
+             40 LOAD_CONST               8 (3)
+             42 LOAD_CONST               4 (0)
+             44 LOAD_CONST               5 (False)
+             46 CALL_FUNCTION            6
+             48 POP_TOP
...
+             40 ROT_TWO
+             42 LOAD_CONST               7 (135)
+             44 LOAD_CONST               3 ('cell')
+             46 LOAD_CONST               4 ('i')
+             48 BUILD_MAP                1
+             50 LOAD_CONST               8 (2)
+             52 LOAD_CONST               5 (1)
+             54 LOAD_CONST               9 (True)
+             56 CALL_FUNCTION            6
+             58 POP_TOP
+             60 UNPACK_SEQUENCE          1
              62 BUILD_TUPLE              1
~             64 LOAD_CONST              10 (<code object g at SOME ADDRESS, file "<string>", line 4>)
              66 LOAD_CONST              11 ('f.<locals>.g')
              68 MAKE_FUNCTION            8
+             70 BUILD_LIST               1
+             72 DUP_TOP
+             74 LOAD_GLOBAL              0 (py_instrument_receiver)
+             76 ROT_TWO
+             78 LOAD_CONST              12 (125)
+             80 LOAD_CONST              13 ('g')
+             82 LOAD_CONST              14 (7)
+             84 LOAD_CONST               5 (1)
+             86 LOAD_CONST               6 (False)
+             88 CALL_FUNCTION            6
+             90 POP_TOP
...
+            104 ROT_TWO
+            106 LOAD_CONST              15 (124)
+            108 LOAD_CONST              13 ('g')
+            110 LOAD_CONST              16 (8)
+            112 LOAD_CONST               5 (1)
+            114 LOAD_CONST               9 (True)
+            116 CALL_FUNCTION            6
+            118 POP_TOP
...
+            128 ROT_TWO
+            130 LOAD_CONST              17 (131)
+            132 LOAD_CONST               1 (0)
+            134 LOAD_CONST              18 (9)
+            136 LOAD_CONST               5 (1)
+            138 LOAD_CONST               6 (False)
+            140 CALL_FUNCTION            6
+            142 POP_TOP
...
+            154 ROT_TWO
+            156 LOAD_CONST              17 (131)
+            158 LOAD_CONST               1 (0)
+            160 LOAD_CONST              18 (9)
+            162 LOAD_CONST               5 (1)
+            164 LOAD_CONST               9 (True)
+            166 CALL_FUNCTION            6
+            168 POP_TOP
...
snapshots['test_while_loop (1, 3, 8)'] = '''
Code Object: <module>
+  3     >>    0 LOAD_GLOBAL              0 (py_instrument_receiver)
+              2 BUILD_LIST               0
+              4 LOAD_CONST               1 ('JUMP_TARGET')
+              6 LOAD_CONST               2 ('label')
+              8 LOAD_CONST               3 (1)
+             10 BUILD_MAP                1
+             12 LOAD_CONST               4 (0)
...
snapshots['test_function_definition (1, 3, 8)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_nonlocal_ref (1, 3, 8)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_while_loop (1, 3, 9)'] = '''
Code Object: <module>
+  3     >>    0 LOAD_GLOBAL              0 (py_instrument_receiver)
+              2 BUILD_LIST               0
+              4 LOAD_CONST               1 ('JUMP_TARGET')
...
snapshots['test_function_definition (1, 3, 9)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_nonlocal_ref (1, 3, 9)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
