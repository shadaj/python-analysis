...
snapshots['test_nested_iteration 1'] = '''
Code Object: <module>
...
snapshots['test_nested_iteration 2'] = [
    {
        'arg': 'myFunc',
        'code': '<module>',
        'is_post': False,
        ...
        'orig_op': 30,
        'stack': [
            GenericRepr('<function myFunc at 0x100000000>')
        ]
    },
    {
        'arg': 'myFunc',
...
snapshots['test_factorial 2'] = [
    {
        ...
        'orig_op': 30,
        'stack': [
            GenericRepr('<function factorial at 0x100000000>')
        ]
    },
    {
        'arg': 'factorial',
...
snapshots['test_nonlocal_load 1'] = '''
Code Object: <module>
...
snapshots['test_nonlocal_load 2'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_scope_forwarding_loads 1'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_scope_forwarding_loads 2'] = [
    {
        'arg': 'x',
        'code': '<module>',
        'is_post': False,
    ...
    },
    {
        ...
        'orig_op': 114,
        'stack': [
            GenericRepr('<function f1 at 0x100000000>')
        ]
    },
    {
        'arg': 'f1',
    ...
    },
    {
        ...
        'orig_op': 150,
        'stack': [
            GenericRepr('<function f1.<locals>.f2 at 0x100000000>')
        ]
    },
    {
        'arg': 'f2',
    ...
    },
    {
        ...
        'orig_op': 208,
        'stack': [
            GenericRepr('<function f1.<locals>.f2.<locals>.f3 at 0x100000000>')
        ]
    },
    {
        'arg': 'f3',
