...
+             62 LOAD_GLOBAL              0 (py_instrument_receiver)
+             64 ROT_TWO
+             66 LOAD_CONST              11 (131)
+             68 LOAD_CONST              12 (0)
+             70 LOAD_CONST              13 (5)
+             72 LOAD_CONST               6 (1)
+             74 LOAD_CONST               7 (False)
+             76 CALL_FUNCTION            6
+             78 POP_TOP
+             80 UNPACK_SEQUENCE          1
              82 CALL_FUNCTION            0
...
+             88 LOAD_GLOBAL              0 (py_instrument_receiver)
+             90 ROT_TWO
+             92 LOAD_CONST              11 (131)
+             94 LOAD_CONST              12 (0)
+             96 LOAD_CONST              13 (5)
+             98 LOAD_CONST               6 (1)
+            100 LOAD_CONST              10 (True)
+            102 CALL_FUNCTION            6
+            104 POP_TOP
+            106 UNPACK_SEQUENCE          1
             108 POP_TOP
...
snapshots['test_load_name (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_NAME                0 (list)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_load_name (2, 3, 8)'] = [
    {
        'arg': 'list',
        'code': '<module>',
        'is_post': True,
...
snapshots['test_store_name (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_store_name (2, 3, 8)'] = [
    {
        'arg': 'x',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_load_attr (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_NAME                0 (range)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_load_attr (2, 3, 8)'] = [
    {
        'arg': 'range',
        'code': '<module>',
        'is_post': True,
...
snapshots['test_store_attr (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_NAME                0 (type)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_store_attr (2, 3, 8)'] = [
    {
        'arg': 'type',
        'code': '<module>',
        'is_post': True,
...
snapshots['test_store_then_load (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_store_then_load (2, 3, 8)'] = [
    {
        'arg': 'x',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_list_load (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
               2 LOAD_CONST               1 (2)
               4 LOAD_CONST               2 (3)
...
snapshots['test_list_load (2, 3, 8)'] = [
    {
        'arg': 'arr',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_list_store (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
               2 LOAD_CONST               1 (2)
               4 LOAD_CONST               2 (3)
...
snapshots['test_list_store (2, 3, 8)'] = [
    {
        'arg': 'arr',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_for_loop (1, 3, 8)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 ((1, 2, 3))
               2 GET_ITER
+        >>    4 LOAD_GLOBAL              0 (py_instrument_receiver)
+              6 BUILD_LIST               0
+              8 LOAD_CONST               1 ('JUMP_TARGET')
+             10 LOAD_CONST               2 ('label')
+             12 LOAD_CONST               3 (3)
+             14 BUILD_MAP                1
+             16 LOAD_CONST               4 (2)
+             18 LOAD_CONST               5 (0)
+             20 LOAD_CONST               6 (False)
+             22 CALL_FUNCTION            6
+             24 POP_TOP
...
+             50 UNPACK_SEQUENCE          1
              52 STORE_NAME               1 (i)
   3          54 JUMP_ABSOLUTE            4
+        >>   56 LOAD_GLOBAL              0 (py_instrument_receiver)
+             58 BUILD_LIST               0
+             60 LOAD_CONST               1 ('JUMP_TARGET')
+             62 LOAD_CONST               2 ('label')
+             64 LOAD_CONST              10 (7)
+             66 BUILD_MAP                1
+             68 LOAD_CONST              11 (6)
+             70 LOAD_CONST               5 (0)
+             72 LOAD_CONST               6 (False)
+             74 CALL_FUNCTION            6
+             76 POP_TOP
...
snapshots['test_function_call (1, 3, 8)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_function_call (2, 3, 8)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_function_call_with_args (1, 3, 8)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_function_call_with_args (2, 3, 8)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_inner_function (1, 3, 8)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_inner_function (2, 3, 8)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_inner_function_nonlocal_ref (1, 3, 8)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_inner_function_nonlocal_ref (2, 3, 8)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_load_name (1, 3, 9)'] = '''
Code Object: <module>
   2           0 LOAD_NAME                0 (list)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_load_name (2, 3, 9)'] = [
    {
        'arg': 'list',
        'code': '<module>',
        'is_post': True,
...
snapshots['test_store_name (1, 3, 9)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_store_name (2, 3, 9)'] = [
    {
        'arg': 'x',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_load_attr (1, 3, 9)'] = '''
Code Object: <module>
   2           0 LOAD_NAME                0 (range)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_load_attr (2, 3, 9)'] = [
    {
        'arg': 'range',
        'code': '<module>',
        'is_post': True,
...
snapshots['test_store_attr (1, 3, 9)'] = '''
Code Object: <module>
   2           0 LOAD_NAME                0 (type)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_store_attr (2, 3, 9)'] = [
    {
        'arg': 'type',
        'code': '<module>',
        'is_post': True,
...
snapshots['test_store_then_load (1, 3, 9)'] = '''
Code Object: <module>
   2           0 LOAD_CONST               0 (1)
+              2 BUILD_LIST               1
+              4 DUP_TOP
...
snapshots['test_store_then_load (2, 3, 9)'] = [
    {
        'arg': 'x',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_list_load (1, 3, 9)'] = '''
Code Object: <module>
   2           0 BUILD_LIST               0
...
+             96 LOAD_GLOBAL              0 (py_instrument_receiver)
+             98 ROT_TWO
+            100 LOAD_CONST              10 (25)
+            102 LOAD_CONST              11 (None)
+            104 LOAD_CONST              12 (6)
+            106 LOAD_CONST               4 (0)
+            108 LOAD_CONST               8 (True)
+            110 CALL_FUNCTION            6
...
snapshots['test_list_load (2, 3, 9)'] = [
    {
        'arg': 'arr',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_list_store (1, 3, 9)'] = '''
Code Object: <module>
   2           0 BUILD_LIST               0
               2 LOAD_CONST               0 ((1, 2, 3))
               4 LIST_EXTEND              1
...
snapshots['test_list_store (2, 3, 9)'] = [
    {
        'arg': 'arr',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_function_call (1, 3, 9)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_function_call (2, 3, 9)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_function_call_with_args (1, 3, 9)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_function_call_with_args (2, 3, 9)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_inner_function (1, 3, 9)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_inner_function (2, 3, 9)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
...
snapshots['test_inner_function_nonlocal_ref (1, 3, 9)'] = '''
Code Object: <module>
~  2           0 LOAD_CONST               0 (<code object f at SOME ADDRESS, file "<string>", line 2>)
               2 LOAD_CONST               1 ('f')
               4 MAKE_FUNCTION            0
...
snapshots['test_inner_function_nonlocal_ref (2, 3, 9)'] = [
    {
        'arg': 'f',
        'code': '<module>',
        'is_post': False,
